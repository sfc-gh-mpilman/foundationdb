...
if(CPACK_GENERATOR MATCHES "RPM")
  ...
  if(GENERATE_EL6)
    ...
    set(CPACK_COMPONENTS_ALL clients-el6 server-el6 clients-${PROJECT_VERSION} server-${PROJECT_VERSION})
  else()
    message(STATUS "Building EL7 components")
    set(CPACK_COMPONENTS_ALL clients-el7 server-el7 clients-${PROJECT_VERSION} server-${PROJECT_VERSION})
  endif()
  set(CPACK_RESOURCE_FILE_README ${CMAKE_SOURCE_DIR}/README.md)
  set(CPACK_RESOURCE_FILE_LICENSE ${CMAKE_SOURCE_DIR}/LICENSE)
elseif(CPACK_GENERATOR MATCHES "DEB")
  set(CPACK_PACKAGING_INSTALL_PREFIX "/")
  set(CPACK_COMPONENTS_ALL clients-deb server-deb clients-${PROJECT_VERSION} server-${PROJECT_VERSION})
  set(CPACK_RESOURCE_FILE_README ${CMAKE_SOURCE_DIR}/README.md)
  set(CPACK_RESOURCE_FILE_LICENSE ${CMAKE_SOURCE_DIR}/LICENSE)
